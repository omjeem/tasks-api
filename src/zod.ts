...
const TaskSchema = z.object({
    ...
    status: z.enum(["Pending", "Completed", "Overdue"]).optional(), // Status must be one of the specified enum values
    isDeleted: z.boolean().optional(), // isDeleted must be a boolean value
